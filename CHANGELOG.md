...
6. For Optimized reports using ArcGIS Web or ArcGIS File System log sources, a bug was fixed that could prevent captured times from being internally stored in UTC; this could have impacted worksheets that listed values with respect to date and time
